...
namespace DAC_MCP4725
{
  ...
  void init() {
    ...
    Serial.println("Многостадийный регулятор для ЦАП на базе MCP4725 инициализирован.");
    delay(500);
  }
  ...
  // =================================================================
  //  ФУНКЦИЯ ДЛЯ НЕПОСРЕДСТВЕННОЙ РАБОТЫ С ЦАПом (12-битный MCP4725)
  // =================================================================
