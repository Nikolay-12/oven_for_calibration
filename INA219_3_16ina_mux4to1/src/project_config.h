...
//static constexpr uint8_t SPI_CLK_PIN = 13; // Пин SCK термопар
//static constexpr uint8_t SPI_MISO_PIN = 12; // ПИН MISO термопар
...
const float DEFAULT_temp_tolarance = 1.0f; // Температурная погрешность
...
// Численные значения настроек для каждого датчика
// 0x40 (перемычки не установлены); 0x41 (перемычка A0); 0x44 (перемычка A1); 0x45 (перемычки A0 и A1).
// Настройки для всех 16 сенсоров
// Канал 0: сенсоры 0-3
// Канал 1: сенсоры 4-7
// Канал 2: сенсоры 8-11
// Канал 3: сенсоры 12-15
static constexpr INA219_descriptor CURRENT_SENSOR_DESCRIPTORS[CURRENT_SENSORS_NUM] = {
    {0x40,  0.1f,  20.0f, 0},      {0x41,  0.1f,  20.0f, 0},      {0x44,  0.1f,  20.0f, 0},      {0x45,  0.1f,  20.0f, 0},       // 1-4
    {0x40,  0.1f,  20.0f, 1},      {0x41,  0.1f,  20.0f, 1},      {0x44,  0.1f,  20.0f, 1},      {0x45,  0.1f,  20.0f, 1},       // 5-8
    {0x40,  0.1f,  20.0f, 2},      {0x41,  0.1f,  20.0f, 2},      {0x44,  0.1f,  20.0f, 2},      {0x45,  0.1f,  20.0f, 2},       // 9-12
    {0x40,  0.1f,  20.0f, 3},      {0x41,  0.1f,  20.0f, 3},      {0x44,  0.1f,  20.0f, 3},      {0x45,  0.1f,  20.0f, 3}       // 13-16
};
...
static constexpr uint8_t MUX_CHANNELS = 4;