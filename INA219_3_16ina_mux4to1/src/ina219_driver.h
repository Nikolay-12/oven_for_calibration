/**
 * @file ina219.h
 * @author thibeaux, modified by Kutukov Pavel
 * @brief INA219 current/voltage monitor driver
 * @version 0.1
 * @date 2022-03-12
 * 
 * Based on https://github.com/thibeaux/STM32_INA219_Library
 * 
...
//
//	Registers: copy/pasted from datasheet
//
...
namespace ina219
{
    ...
    // setAveraging function sets the number of current measurements in one averaging
    void setAveraging(uint8_t addr, uint8_t mode);  // mode: 0 - 1, 1 = 2, 2 = 4, 3 = 8, 4 = 16, 5 - 32, 6 - 64, 7 - 128 
